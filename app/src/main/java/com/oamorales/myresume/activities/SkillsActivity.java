...
public class SkillsActivity extends AppCompatActivity /*implements NavigationView.OnNavigationItemSelectedListener*/ {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //navView.getMenu().findItem(R.id.skillsMenu).setChecked(true);
    ...
    private void configureToolbar(){
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(R.string.skills);
